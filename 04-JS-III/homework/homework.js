...
function devolverUltimoElemento(array) {
  ...
  // Tu código:
  return array[array.length -1]; //array[7]
}
...
function arrayContiene(array, elemento) {
  ...
  // Tu código:
  // [1, 2, 3]
  //Elemento = 3 que lo busque el elemento y si no esta devuelva false
...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  // [1, 2, 3, 4] suma todo y luego divide por la cantidad de elementos
  var promedio = 0;
...
function breakStatement(numero) {
  ...
  //la cantidad de iteraciones coinciden, 
